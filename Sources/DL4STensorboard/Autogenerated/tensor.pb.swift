...
struct Tensorflow_TensorProto: @unchecked Sendable {
  ...
  var tensorShape: Tensorflow_TensorShapeProto {
    get {_storage._tensorShape ?? Tensorflow_TensorShapeProto()}
    set {_uniqueStorage()._tensorShape = newValue}
  }
  /// Returns true if `tensorShape` has been explicitly set.
  var hasTensorShape: Bool {_storage._tensorShape != nil}
  ...
  var float8Val: Data {
    get {_storage._float8Val}
    set {_uniqueStorage()._float8Val = newValue}
  }
...
struct Tensorflow_VariantTensorDataProto: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Tensorflow_TensorProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}dtype\0\u{3}tensor_shape\0\u{3}version_number\0\u{3}tensor_content\0\u{3}float_val\0\u{3}double_val\0\u{3}int_val\0\u{3}string_val\0\u{3}scomplex_val\0\u{3}int64_val\0\u{3}bool_val\0\u{3}dcomplex_val\0\u{3}half_val\0\u{3}resource_handle_val\0\u{3}variant_val\0\u{3}uint32_val\0\u{3}uint64_val\0\u{3}float8_val\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 18: try { try decoder.decodeSingularBytesField(value: &_storage._float8Val) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._float8Val.isEmpty {
        try visitor.visitSingularBytesField(value: _storage._float8Val, fieldNumber: 18)
      }
    }
  ...
  static func ==(lhs: Tensorflow_TensorProto, rhs: Tensorflow_TensorProto) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._float8Val != rhs_storage._float8Val {return false}
        return true
      }
...
extension Tensorflow_VariantTensorDataProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}type_name\0\u{1}metadata\0\u{1}tensors\0")
